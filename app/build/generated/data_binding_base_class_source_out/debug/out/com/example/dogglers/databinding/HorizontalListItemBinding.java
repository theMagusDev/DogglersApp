...
public final class HorizontalListItemBinding implements ViewBinding {
  ...
  private HorizontalListItemBinding(@NonNull MaterialCardView rootView,
      @NonNull Button detailsButton, @NonNull TextView dogAge, @NonNull TextView dogHobbies,
  ...
  public static HorizontalListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new HorizontalListItemBinding((MaterialCardView) rootView, detailsButton, dogAge,
