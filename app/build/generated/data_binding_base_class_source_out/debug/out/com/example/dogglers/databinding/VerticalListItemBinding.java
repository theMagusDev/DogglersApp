...
public final class VerticalListItemBinding implements ViewBinding {
  @NonNull
  ...
  private VerticalListItemBinding(@NonNull MaterialCardView rootView, @NonNull Button detailsButton,
  ...
  @NonNull
  public static VerticalListItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static VerticalListItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.vertical_list_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static VerticalListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new VerticalListItemBinding((MaterialCardView) rootView, detailsButton, dogAge,
          dogHobbies, dogImage, dogName);
    }
